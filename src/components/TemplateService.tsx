...
const templateData: Record<string, SubCategory[]> = {
  ...
  business: [
    ...
    },
    {
      ...
      emoji: "💇",
      templates: [
        { code: "B28", name: "헤어 살롱", desc: "미용실용", preview: "💇", demoUrl: "/template/B28", available: false },
        { code: "B29", name: "네일 아트", desc: "네일샵용", preview: "💅", demoUrl: "/template/B29", available: false },
        { code: "B30", name: "뷰티 샵", desc: "종합 뷰티", preview: "💄", demoUrl: "/template/B30", available: false },
      ],
    },
    {
      id: "namecard",
      ...
      emoji: "💳",
      templates: [
        { code: "B31", name: "심플 명함", desc: "깔끔한 명함", preview: "📇", demoUrl: "/template/B31", available: false },
        { code: "B32", name: "QR 명함", desc: "QR코드 포함", preview: "📱", demoUrl: "/template/B32", available: false },
        { code: "B33", name: "프리미엄 명함", desc: "고급스러운 디자인", preview: "✨", demoUrl: "/template/B33", available: false },
      ],
    },
  ],
  event: [
