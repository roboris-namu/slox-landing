...
const templateData: Record<string, SubCategory[]> = {
  ...
  business: [
    ...
    },
    {
      ...
      emoji: "💳",
      templates: [
        { code: "B37", name: "심플 명함", desc: "깔끔한 명함", preview: "📇", demoUrl: "/template/B37", available: false },
        { code: "B38", name: "QR 명함", desc: "QR코드 포함", preview: "📱", demoUrl: "/template/B38", available: false },
        { code: "B39", name: "프리미엄 명함", desc: "고급스러운 디자인", preview: "✨", demoUrl: "/template/B39", available: false },
      ],
    },
  ],
  event: [
