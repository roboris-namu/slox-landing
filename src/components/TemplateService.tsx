...
const templateData: Record<string, SubCategory[]> = {
  personal: [
    ...
    },
    {
      ...
      emoji: "💻",
      templates: [
        { code: "P37", name: "GitHub 스타일", desc: "개발자 감성", preview: "🐙", demoUrl: "/template/P37", available: true },
        { code: "P38", name: "터미널 테마", desc: "해커 감성 디자인", preview: "⌨️", demoUrl: "/template/P38", available: true },
        { code: "P39", name: "테크 모던", desc: "기술 중심 레이아웃", preview: "🚀", demoUrl: "/template/P39", available: true },
        { code: "P40", name: "코드 에디터", desc: "VSCode 스타일", preview: "💻", demoUrl: "/template/P40", available: true },
        { code: "P41", name: "매트릭스", desc: "매트릭스 테마", preview: "🟢", demoUrl: "/template/P41", available: true },
        { code: "P42", name: "깃허브 다크", desc: "깃허브 다크 테마", preview: "🖤", demoUrl: "/template/P42", available: true },
        { code: "P43", name: "오픈소스", desc: "오픈소스 프로필", preview: "📦", demoUrl: "/template/P43", available: true },
        { code: "P44", name: "풀스택", desc: "풀스택 개발자용", preview: "🔧", demoUrl: "/template/P44", available: true },
        { code: "P45", name: "스타트업", desc: "스타트업 개발자", preview: "⚡", demoUrl: "/template/P45", available: true },
      ],
    },
  ],
  family: [
    ...
    },
    {
      ...
      emoji: "🐕",
      templates: [
        { code: "F10", name: "댕댕이 일기", desc: "강아지 전용", preview: "🐶", demoUrl: "/template/F10", available: false },
        { code: "F11", name: "냥이 앨범", desc: "고양이 전용", preview: "🐱", demoUrl: "/template/F11", available: false },
        { code: "F12", name: "펫 다이어리", desc: "모든 반려동물", preview: "🐾", demoUrl: "/template/F12", available: false },
        { code: "F13", name: "펫 포토북", desc: "사진 중심 앨범", preview: "📸", demoUrl: "/template/F13", available: false },
        { code: "F14", name: "성장일기", desc: "반려동물 성장기록", preview: "📏", demoUrl: "/template/F14", available: false },
        { code: "F15", name: "펫 프로필", desc: "반려동물 소개", preview: "🎀", demoUrl: "/template/F15", available: false },
        { code: "F16", name: "귀염뽀짝", desc: "귀여운 테마", preview: "💕", demoUrl: "/template/F16", available: false },
        { code: "F17", name: "자연 테마", desc: "자연 배경", preview: "🌿", demoUrl: "/template/F17", available: false },
        { code: "F18", name: "플레이풀", desc: "발랄한 분위기", preview: "🎾", demoUrl: "/template/F18", available: false },
      ],
    },
    {
      id: "kids",
      ...
      emoji: "👶",
      templates: [
        { code: "F19", name: "베이비 그로스", desc: "성장 기록", preview: "👶", demoUrl: "/template/F19", available: false },
        { code: "F20", name: "키즈 타임라인", desc: "연령별 기록", preview: "📏", demoUrl: "/template/F20", available: false },
        { code: "F21", name: "포토 다이어리", desc: "사진 중심", preview: "📷", demoUrl: "/template/F21", available: false },
        { code: "F22", name: "첫돌 앨범", desc: "돌잔치용", preview: "🎂", demoUrl: "/template/F22", available: false },
        { code: "F23", name: "스쿨 메모리", desc: "학교생활 기록", preview: "🎒", demoUrl: "/template/F23", available: false },
        { code: "F24", name: "드림 키즈", desc: "꿈꾸는 아이", preview: "⭐", demoUrl: "/template/F24", available: false },
        { code: "F25", name: "파스텔 베이비", desc: "파스텔톤", preview: "🍼", demoUrl: "/template/F25", available: false },
        { code: "F26", name: "플레이타임", desc: "놀이 기록", preview: "🧸", demoUrl: "/template/F26", available: false },
        { code: "F27", name: "마일스톤", desc: "성장 이정표", preview: "🏆", demoUrl: "/template/F27", available: false },
      ],
    },
    {
      id: "friends",
      ...
      emoji: "🎓",
      templates: [
        { code: "F28", name: "동창회 모임", desc: "학교 동창 페이지", preview: "🎓", demoUrl: "/template/F28", available: false },
        { code: "F29", name: "동호회 소개", desc: "취미 모임용", preview: "⚽", demoUrl: "/template/F29", available: false },
        { code: "F30", name: "여행 기록", desc: "여행 추억 페이지", preview: "✈️", demoUrl: "/template/F30", available: false },
        { code: "F31", name: "운동 동호회", desc: "스포츠 모임", preview: "🏃", demoUrl: "/template/F31", available: false },
        { code: "F32", name: "독서 모임", desc: "북클럽용", preview: "📚", demoUrl: "/template/F32", available: false },
        { code: "F33", name: "음악 동호회", desc: "밴드/합창단", preview: "🎵", demoUrl: "/template/F33", available: false },
        { code: "F34", name: "사진 동호회", desc: "출사 모임", preview: "📷", demoUrl: "/template/F34", available: false },
        { code: "F35", name: "등산 모임", desc: "산악회용", preview: "⛰️", demoUrl: "/template/F35", available: false },
        { code: "F36", name: "맛집 탐방", desc: "미식 모임", preview: "🍽️", demoUrl: "/template/F36", available: false },
      ],
    },
  ],
  business: [
