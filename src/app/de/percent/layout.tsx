...
export const metadata: Metadata = {
  title: "Prozentrechner | SLOX",
  description: "Kostenloser Prozentrechner. Prozente einfach berechnen.",
  keywords: ["Prozentrechner", "percent calculator"],
  alternates: {
    canonical: "https://www.slox.co.kr/de/percent",
    languages: {
  ...
  openGraph: {
    type: "website",
    locale: "de_DE",
    url: "https://www.slox.co.kr/de/percent",
    siteName: "SLOX",
    title: "Prozentrechner | SLOX",
  },
