  ...
  const banners = [
    {
      ...
      subtitle: "🎁 Win $5 Gift Card! - Event in progress",
      cta: "Challenge Now",
      href: "/en/reaction",
    ...
    {
      title: "🧠 IQ Test",
      subtitle: "What's your IQ? - 12 pattern questions",
      cta: "Take Test",
      href: "/en/iq",
    ...
    {
      title: "📚 Trivia Quiz",
      subtitle: "Test your knowledge! - 10 questions",
      cta: "Start Quiz",
      href: "/en/quiz",
    ...
    {
      title: "🧩 Sudoku",
      subtitle: "Brain training puzzle - 3 difficulties",
      cta: "Play Now",
      href: "/en/sudoku",
    ...
    {
      title: "🎨 Color Finder",
      subtitle: "Find the different color! - Eye test",
      cta: "Challenge",
      href: "/en/color",
    ...
    {
      title: "🖱️ CPS Test",
      subtitle: "How fast can you click? - Clicks per second",
      cta: "Test Now",
      href: "/en/cps",
