export default function WhiteNoisePrivacy() {
  return (
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6 text-gray-300">
          <section>
            ...
            <p>White Noise - SLOX does not collect, store, or transmit any personal data. All audio playback and settings are processed locally on your device.</p>
          </section>

          <section>
            <h3 className="text-xl font-semibold text-white mb-2">Permissions</h3>
            <p>This app only requires audio playback permission to play ambient sounds in the background. No microphone access is required or requested.</p>
          </section>
          ...
          <section>
            ...
            <p>Only your preferences (language settings, volume levels) are stored locally on your device. This data is never transmitted to external servers.</p>
          </section>

          <section>
            <h3 className="text-xl font-semibold text-white mb-2">Audio Files</h3>
            <p>All ambient sound files are bundled within the app and played locally. No streaming or external downloads are required.</p>
          </section>
