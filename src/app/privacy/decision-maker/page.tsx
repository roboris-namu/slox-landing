...
export const metadata: Metadata = {
  title: 'Privacy Policy - Decision Maker | SLOX',
  description: 'Privacy Policy for Decision Maker - SLOX, a simple random picker for tough choices.',
};

export default function DecisionMakerPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">
          Privacy Policy - Decision Maker - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Decision Maker - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use
              our mobile application. Decision Maker - SLOX is a lightweight utility
              that picks one option at random from a list you type in (or rolls a die,
              flips a coin, or returns Yes/No). It is purely for entertainment.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Decision Maker - SLOX does not
              require sign-up, sign-in, or any user account. We do not collect names,
              email addresses, phone numbers, or any other personally identifiable
              information.
            </p>
            <p className="mb-2">
              <strong>No Server Communication:</strong> The App itself does not transmit
              any personal data to our servers. All decisions run entirely on your device.
            </p>
            <p>
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Your custom options list (e.g. food choices, names you typed in)</li>
              <li>Past decision history (last 50 results)</li>
              <li>Your selected language and theme</li>
            </ul>
            <p className="mt-2">
              This data never leaves your device and can be cleared by uninstalling the
              App or using the &quot;Clear&quot; buttons in Settings.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              Decision Maker - SLOX displays advertisements through <strong>Google AdMob</strong>,
            ...
            <p className="mt-2">
              ...
              . Your custom options and decision history are NEVER shared with AdMob or
          ...
          <section>
            ...
            <p>
              Decision Maker - SLOX is an entertainment utility. The results it returns
              are produced by a pseudo-random number generator and are NOT intended for
              gambling, betting, financial, medical, legal, or any other consequential
              decision-making. Use it for fun, not for important life choices.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Decision Maker - SLOX is rated 4+ on iOS. We do not knowingly collect
          ...
          <section>
            ...
            <p>
              Because Decision Maker - SLOX does not collect, transmit, or store personal
