...
export const metadata: Metadata = {
  title: 'Privacy Policy - Countdown | SLOX',
  description: 'Privacy Policy for Countdown - SLOX, a D-Day and event countdown app.',
};
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-rose-400 to-orange-400 bg-clip-text text-transparent">
          Privacy Policy - Countdown - SLOX
        </h1>

        <div className="text-gray-300 space-y-6">
          <p className="text-sm text-gray-500">Last updated: June 28, 2026</p>

          <section>
            <h2 className="text-xl font-semibold text-white mb-3">1. Introduction</h2>
            <p>
              This Privacy Policy explains how Countdown - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Countdown - SLOX helps you track days until important
              events such as exams, birthdays, vacations, and weddings.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Countdown - SLOX does not require sign-up
              or sign-in.
            </p>
            <p>
              <strong>Local Storage Only:</strong> The App stores your countdown events,
              titles, dates, colors, emojis, pin settings, and preferences on your device.
          ...
          <section>
            ...
            <p className="mb-2">
              Countdown - SLOX displays advertisements through <strong>Google AdMob</strong>,
            ...
            <p>
              ...
              See{' '}
              <a href="https://policies.google.com/privacy" className="text-rose-400 underline" target="_blank" rel="noopener noreferrer">
