...
export const metadata: Metadata = {
  title: 'Privacy Policy - Tabata Timer | SLOX',
  description: 'Privacy Policy for Tabata Timer - SLOX, a Tabata interval training timer app.',
};

export default function TabataTimerPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
          Privacy Policy - Tabata Timer - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Tabata Timer - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Tabata Timer - SLOX is a Tabata-style interval training
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Tabata Timer - SLOX does not require sign-up
              or sign-in.
            </p>
            <p>
              <strong>Local Storage Only:</strong> The App stores your timer settings, preset
              choices, session stats, and preferences on your device. This data is not uploaded
              to our servers.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              Tabata Timer - SLOX displays advertisements through <strong>Google AdMob</strong>,
