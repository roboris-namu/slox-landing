...
export const metadata: Metadata = {
  title: 'Privacy Policy - Trivia Quiz | SLOX',
  description: 'Privacy Policy for Trivia Quiz - SLOX, a general-knowledge multiple-choice quiz game.',
};
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-violet-400 to-pink-400 bg-clip-text text-transparent">
          Privacy Policy - Trivia Quiz - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Trivia Quiz - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Trivia Quiz - SLOX is a general-knowledge multiple-choice
              quiz game where players answer questions across various categories within a time
              limit to earn scores.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Trivia Quiz - SLOX does not require sign-up,
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Your best score, recent records, and category progress</li>
          ...
          <section>
            ...
            <p className="mb-2">
              Trivia Quiz - SLOX displays advertisements through <strong>Google AdMob</strong>,
          ...
          <section>
            ...
            <p>
              Trivia Quiz - SLOX is rated 4+ and is safe for users of all ages, but it is not
          ...
          <section>
            ...
            <p>
              Because Trivia Quiz - SLOX does not collect, transmit, or store personal data on
