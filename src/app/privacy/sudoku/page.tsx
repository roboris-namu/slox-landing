...
export const metadata: Metadata = {
  title: 'Privacy Policy - Sudoku | SLOX',
  description: 'Privacy Policy for Sudoku - SLOX, a classic 9x9 sudoku puzzle game.',
};

export default function SudokuPrivacyPage() {
  return (
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Sudoku - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Sudoku - SLOX is a classic 9x9 sudoku puzzle game with
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Sudoku - SLOX does not require sign-up,
            ...
            <p className="mb-2">
              ...
              personal data to our servers. Puzzle generation and validation run entirely on
              your device.
            </p>
            <p>
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Your current saved game, completion stats, and best times</li>
              <li>Your selected language and difficulty</li>
              <li>Your sound/vibration and visual-aid preferences</li>
            </ul>
            <p className="mt-2">
          ...
          <section>
            ...
            <p className="mb-2">
              Sudoku - SLOX displays advertisements through <strong>Google AdMob</strong>,
          ...
          <section>
            ...
            <p>
              Sudoku - SLOX is rated 4+ and is safe for users of all ages, but it is not
          ...
          <section>
            ...
            <p>
              Because Sudoku - SLOX does not collect, transmit, or store personal data on
