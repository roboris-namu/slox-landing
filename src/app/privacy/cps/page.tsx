...
export const metadata: Metadata = {
  title: 'Privacy Policy - CPS Test | SLOX',
  description: 'Privacy Policy for CPS Test - SLOX, a clicks-per-second measurement game.',
};

export default function CpsPrivacyPage() {
  return (
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how CPS Test - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. CPS Test - SLOX is a clicks-per-second measurement game where
              players tap as many times as possible within a fixed time window.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> CPS Test - SLOX does not require sign-up,
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Your best CPS score and recent records</li>
              <li>Your selected language</li>
              <li>Your sound/vibration preferences</li>
              <li>Your selected duration mode (5s / 10s / 30s, etc.)</li>
            </ul>
            <p className="mt-2">
          ...
          <section>
            ...
            <p className="mb-2">
              CPS Test - SLOX displays advertisements through <strong>Google AdMob</strong>,
          ...
          <section>
            ...
            <p>
              CPS Test - SLOX is rated 4+ and is safe for users of all ages, but it is not
          ...
          <section>
            ...
            <p>
              Because CPS Test - SLOX does not collect, transmit, or store personal data on
