...
export const metadata: Metadata = {
  title: 'Privacy Policy - Interval Timer | SLOX',
  description: 'Privacy Policy for Interval Timer - SLOX, a workout interval timer app.',
};

export default function IntervalTimerPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">
          Privacy Policy - Interval Timer - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Interval Timer - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Interval Timer - SLOX is a workout interval timer for
              HIIT, Tabata, and custom work/rest routines.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Interval Timer - SLOX does not require sign-up
              or sign-in.
            </p>
            <p>
              <strong>Local Storage Only:</strong> The App stores your timer settings, presets,
              and language preference on your device. This data is not uploaded to our servers.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              Interval Timer - SLOX displays advertisements through <strong>Google AdMob</strong>,
