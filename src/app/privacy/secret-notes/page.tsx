...
export const metadata: Metadata = {
  title: 'Privacy Policy - Secret Notes | SLOX',
  description: 'Privacy Policy for Secret Notes - SLOX, a PIN/biometric-locked offline notepad.',
};

export default function SecretNotesPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
          Privacy Policy - Secret Notes - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Secret Notes - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Secret Notes - SLOX is an offline notepad that lets you
              write notes and protect them with a PIN code and/or device biometric
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Secret Notes - SLOX does not require
            ...
            <p className="mb-2">
              ...
              any personal data to our servers. All note content and security settings are
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Note titles and body text</li>
              <li>A hashed PIN code (the original PIN is never stored)</li>
              <li>Biometric-enabled flag (no biometric data itself is stored)</li>
              <li>Your selected language and theme</li>
            </ul>
            <p className="mt-2">
              This data never leaves your device and can be cleared by uninstalling the
              App. The App does NOT use cloud sync or any external service for your notes.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-3">3. Biometric Authentication</h2>
            <p>
              The App uses the system biometric API (Face ID or Touch ID on iOS) only as a
              local verification step to unlock the App. Biometric data is processed
              entirely on your device by Apple&apos;s Secure Enclave and is NEVER accessible
              to the App, transmitted off-device, or stored on any server.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              Secret Notes - SLOX displays advertisements through <strong>Google AdMob</strong>,
            ...
            <p className="mt-2">
              ...
              . Your note content, PIN, and biometric status are NEVER shared with AdMob
          ...
          <section>
            ...
            <p>
              Because Secret Notes - SLOX does not collect, transmit, or store personal
              data on our servers, there is no personal data on our side to secure.
              Locally stored notes are protected by the standard sandbox of your operating
              system, the in-app PIN (hashed), and optional biometric verification.
              IMPORTANT: If you forget your PIN, there is no recovery channel — notes
              cannot be unlocked because we cannot reverse the local hash.
            </p>
          </section>
