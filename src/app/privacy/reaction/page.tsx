...
export const metadata: Metadata = {
  title: 'Privacy Policy - Reaction Test | SLOX',
  description: 'Privacy Policy for Reaction Test - SLOX, a reaction speed measurement game.',
};

export default function ReactionPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-red-500 to-amber-400 bg-clip-text text-transparent">
          Privacy Policy - Reaction Test - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Reaction Test - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Reaction Test - SLOX is a reaction speed measurement game where
              players tap as quickly as possible when a colored signal changes.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Reaction Test - SLOX does not require sign-up,
            ...
            <p className="mb-2">
              ...
              personal data to our servers. Game logic runs entirely on your device.
            </p>
            <p>
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Your best reaction time and statistics</li>
          ...
          <section>
            ...
            <p className="mb-2">
              Reaction Test - SLOX displays advertisements through <strong>Google AdMob</strong>,
          ...
          <section>
            ...
            <p>
              Reaction Test - SLOX is rated 4+ and is safe for users of all ages, but it is not
          ...
          <section>
            ...
            <p>
              Because Reaction Test - SLOX does not collect, transmit, or store personal data on
