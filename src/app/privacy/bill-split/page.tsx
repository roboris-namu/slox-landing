...
export const metadata: Metadata = {
  title: 'Privacy Policy - Bill Split | SLOX',
  description: 'Privacy Policy for Bill Split - SLOX, a bill splitting and tip calculator app.',
};

export default function BillSplitPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">
          Privacy Policy - Bill Split - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Bill Split - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Bill Split - SLOX helps you split bills, calculate tips,
              and show per-person amounts with optional rounding.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Bill Split - SLOX does not require sign-up
              or sign-in.
            </p>
            <p>
              <strong>Local Storage Only:</strong> The App may store currency preference, default
              tip percentage, rounding mode, and language settings on your device. Bill amounts
              you enter are processed locally and are not uploaded to our servers.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              Bill Split - SLOX displays advertisements through <strong>Google AdMob</strong>,
