...
export const metadata: Metadata = {
  title: 'Privacy Policy - HIIT Timer | SLOX',
  description: 'Privacy Policy for HIIT Timer - SLOX, a high-intensity interval training timer app.',
};

export default function HiitTimerPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent">
          Privacy Policy - HIIT Timer - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how HIIT Timer - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. HIIT Timer - SLOX is a high-intensity interval training
              timer with work/rest rounds, presets, sound, and vibration alerts.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> HIIT Timer - SLOX does not require sign-up
              or sign-in.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-2">
              HIIT Timer - SLOX displays advertisements through <strong>Google AdMob</strong>,
