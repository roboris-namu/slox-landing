...
export const metadata: Metadata = {
  title: 'Privacy Policy - Boxing Timer | SLOX',
  description: 'Privacy Policy for Boxing Timer - SLOX, a boxing round and rest interval timer app.',
};

export default function BoxingTimerPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-red-400 to-rose-500 bg-clip-text text-transparent">
          Privacy Policy - Boxing Timer - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Boxing Timer - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Boxing Timer - SLOX is a boxing round timer with
              work/rest intervals, presets, sound, and vibration alerts.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Boxing Timer - SLOX does not require sign-up
              or sign-in.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-2">
              Boxing Timer - SLOX displays advertisements through <strong>Google AdMob</strong>,
            ...
            <p>
              ...
              See{' '}
              <a href="https://policies.google.com/privacy" className="text-red-400 underline" target="_blank" rel="noopener noreferrer">
