...
export const metadata: Metadata = {
  title: 'Privacy Policy - Egg Timer | SLOX',
  description: 'Privacy Policy for Egg Timer - SLOX, a boiled egg timer app.',
};

export default function EggTimerPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-amber-400 to-yellow-300 bg-clip-text text-transparent">
          Privacy Policy - Egg Timer - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Egg Timer - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Egg Timer - SLOX helps you boil eggs to soft, medium,
              or hard doneness based on egg size and starting temperature.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Egg Timer - SLOX does not require sign-up
              or sign-in.
            </p>
            <p>
              <strong>Local Storage Only:</strong> The App stores your egg size, doneness,
              temperature preference, and language settings on your device. This data is not
          ...
          <section>
            ...
            <p className="mb-2">
              Egg Timer - SLOX displays advertisements through <strong>Google AdMob</strong>,
            ...
            <p>
              ...
              See{' '}
              <a href="https://policies.google.com/privacy" className="text-amber-400 underline" target="_blank" rel="noopener noreferrer">
