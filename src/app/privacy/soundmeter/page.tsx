...
export const metadata: Metadata = {
  title: 'Privacy Policy - Sound Meter App | SLOX',
  description: 'Privacy Policy for Sound Meter - Decibel dB app by SLOX',
};

export default function SoundMeterPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-indigo-500 to-cyan-400 bg-clip-text text-transparent">
          Privacy Policy - Sound Meter
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Sound Meter - Decibel dB (&quot;we&quot;, &quot;our&quot;, or &quot;the App&quot;) 
          ...
          <section>
            ...
            <p className="mb-2">
              ...
              to measure sound levels. Audio data is processed locally on your device and is NOT 
          ...
          <section>
            ...
            <p>
              The microphone data is used solely to calculate and display decibel (dB) levels in 
              real-time. All processing occurs locally on your device. No audio data leaves your device.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Sound Meter does not store any audio recordings or sound measurements. When you close 
              the app, all data is cleared from memory. We do not use cloud storage or external servers 
              to store your data.
            </p>
          </section>
