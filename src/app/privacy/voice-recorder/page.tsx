...
export const metadata: Metadata = {
  title: 'Privacy Policy - Voice Recorder App | SLOX',
  description: 'Privacy Policy for Voice Recorder - SLOX app',
};

export default function VoiceRecorderPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-orange-500 to-red-400 bg-clip-text text-transparent">
          Privacy Policy - Voice Recorder - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Voice Recorder - SLOX (&quot;we&quot;, &quot;our&quot;, or &quot;the App&quot;) 
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>Microphone Access:</strong> The App requires access to your device&apos;s microphone 
              to record audio. Audio data is processed and stored locally on your device and is NOT 
              transmitted to any server.
            </p>
            <p className="mb-2">
              <strong>Recording Storage:</strong> All audio recordings are stored locally on your device. 
          ...
          <section>
            ...
            <p>
              The microphone data is used solely to record audio. All processing occurs locally 
              on your device. No data leaves your device unless you choose to share it using the 
              share feature.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Voice Recorder stores your audio recordings locally on your device for your convenience. 
              You can delete any recording at any time from within the app. We do not use cloud storage or 
