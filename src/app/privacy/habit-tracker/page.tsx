...
export const metadata: Metadata = {
  title: 'Privacy Policy - Habit Tracker | SLOX',
  description: 'Privacy Policy for Habit Tracker - SLOX, a simple offline habit tracker.',
};
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-lime-400 to-orange-400 bg-clip-text text-transparent">
          Privacy Policy - Habit Tracker - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Habit Tracker - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Habit Tracker - SLOX is a simple offline habit checklist
              that helps you mark daily habits as completed and view streaks and statistics.
              It is NOT a medical or behavioral therapy device.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Habit Tracker - SLOX does not require
            ...
            <p className="mb-2">
              ...
              any personal data to our servers. All habit data is stored entirely on your
              device.
            </p>
            <p>
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Habit names, icons, and colors you create</li>
              <li>Daily check-in records and streak counts</li>
            ...
            <p className="mt-2">
              ...
              cloud sync, or any other external service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              Habit Tracker - SLOX displays advertisements through <strong>Google AdMob</strong>,
            ...
            <p className="mt-2">
              ...
              . Your habit names, check-in records, and settings are NEVER shared with AdMob
          ...
          <section>
            ...
            <p>
              Because Habit Tracker - SLOX does not collect, transmit, or store personal
