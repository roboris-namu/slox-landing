...
export const metadata: Metadata = {
  title: 'Privacy Policy - EMOM Timer | SLOX',
  description: 'Privacy Policy for EMOM Timer - SLOX, an Every Minute On the Minute workout timer app.',
};

export default function EmomTimerPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-violet-400 to-purple-500 bg-clip-text text-transparent">
          Privacy Policy - EMOM Timer - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how EMOM Timer - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. EMOM Timer - SLOX is an Every Minute On the Minute
              workout timer with presets, sound, and vibration alerts.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> EMOM Timer - SLOX does not require sign-up
              or sign-in.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-2">
              EMOM Timer - SLOX displays advertisements through <strong>Google AdMob</strong>,
