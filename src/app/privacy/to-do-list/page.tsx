...
export const metadata: Metadata = {
  title: 'Privacy Policy - To-Do List | SLOX',
  description: 'Privacy Policy for To-Do List - SLOX, a simple offline to-do list app.',
};

export default function TodoListPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-sky-400 to-indigo-400 bg-clip-text text-transparent">
          Privacy Policy - To-Do List - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how To-Do List - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. To-Do List - SLOX is a simple offline task list that lets
              you add, check off, and reorder tasks on your device.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> To-Do List - SLOX does not require
            ...
            <p className="mb-2">
              ...
              any personal data to our servers. All task data is stored entirely on your
              device.
            </p>
            <p>
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Task titles, completion status, and order</li>
              <li>Your selected language and theme</li>
            </ul>
            <p className="mt-2">
              This data never leaves your device and can be cleared by uninstalling the
              App or using the clear options in the settings. The App does NOT use cloud
              sync or any external service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              To-Do List - SLOX displays advertisements through <strong>Google AdMob</strong>,
            ...
            <p className="mt-2">
              ...
              . Your task content and settings are NEVER shared with AdMob or any other
              advertising network.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Because To-Do List - SLOX does not collect, transmit, or store personal data
              on our servers, there is no personal data on our side to secure. Locally
              stored data is protected by the standard sandbox of your operating system.
            </p>
          </section>
