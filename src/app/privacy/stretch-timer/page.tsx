...
export const metadata: Metadata = {
  title: 'Privacy Policy - Stretch Timer | SLOX',
  description: 'Privacy Policy for Stretch Timer - SLOX, a body-part stretching sequence timer app.',
};

export default function StretchTimerPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-lime-400 to-green-500 bg-clip-text text-transparent">
          Privacy Policy - Stretch Timer - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Stretch Timer - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Stretch Timer - SLOX is a stretching sequence timer with
              hold and transition intervals, presets, sound, and vibration alerts.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Stretch Timer - SLOX does not require sign-up
              or sign-in.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-2">
              Stretch Timer - SLOX displays advertisements through <strong>Google AdMob</strong>,
