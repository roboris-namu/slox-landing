...
export const metadata: Metadata = {
  title: 'Privacy Policy - Quit Smoking | SLOX',
  description: 'Privacy Policy for Quit Smoking - SLOX, a simple smoke-free day counter.',
};

export default function QuitSmokingPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-sky-400 to-emerald-400 bg-clip-text text-transparent">
          Privacy Policy - Quit Smoking - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Quit Smoking - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Quit Smoking - SLOX is a lifestyle counter that tracks
              the time elapsed since the user&apos;s quit date and displays motivational
              statistics such as cigarettes avoided, money saved, and generic health
              milestones. It is NOT a medical device and does NOT provide medical advice.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Quit Smoking - SLOX does not require
            ...
            <p className="mb-2">
              ...
              any personal data to our servers. All counters run entirely on your device.
            </p>
            <p>
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Your quit date</li>
              <li>Cigarettes per day, price per pack, currency</li>
          ...
          <section>
            ...
            <p className="mb-2">
              Quit Smoking - SLOX displays advertisements through <strong>Google AdMob</strong>,
            ...
            <p className="mt-2">
              ...
              . Your quit date and counter inputs are NEVER shared with AdMob or any other
              advertising network.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Quit Smoking - SLOX is a general lifestyle utility, NOT a medical device.
              The health milestones shown in the app are based on widely-cited generic
              references and are for motivational purposes only. The app does NOT provide
              medical advice, diagnosis, or treatment, and does NOT prescribe any cessation
              program. For personalized smoking cessation help, please consult a qualified
              healthcare professional or your local quit-smoking helpline.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Quit Smoking - SLOX is rated 17+ on iOS because it discusses smoking and
              tobacco. We do not knowingly collect personal information from children.
              Because advertisements are delivered by Google AdMob, the App is not suitable
              for designated &quot;Kids Category&quot; distribution.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Because Quit Smoking - SLOX does not collect, transmit, or store personal
