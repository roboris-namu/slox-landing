...
export const metadata: Metadata = {
  title: 'Privacy Policy - Card Match | SLOX',
  description: 'Privacy Policy for Card Match - SLOX, a 4x4 memory card matching game.',
};

export default function CardMatchPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-amber-400 to-rose-500 bg-clip-text text-transparent">
          Privacy Policy - Card Match - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Card Match - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Card Match - SLOX is a 4x4 memory card-matching game: cards
              are revealed for a few seconds, then players flip pairs to find eight matches
              within a time limit, earning combo bonuses for consecutive matches.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Card Match - SLOX does not require sign-up,
            ...
            <p className="mb-2">
              ...
              a freely-chosen public nickname, the score (matches, combo, time), and the
              language code. No device identifier, email, or personal information is sent.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-2">
              Card Match - SLOX displays advertisements through <strong>Google AdMob</strong>,
          ...
          <section>
            ...
            <p>
              Card Match - SLOX is rated 4+ and is safe for users of all ages, but it is not
