...
export const metadata: Metadata = {
  title: 'Privacy Policy - Aim Trainer | SLOX',
  description: 'Privacy Policy for Aim Trainer - SLOX, a moving-target aim and reaction training game.',
};

export default function AimTrainerPrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 bg-gradient-to-r from-red-500 to-orange-400 bg-clip-text text-transparent">
          Privacy Policy - Aim Trainer - SLOX
        </h1>
        ...
        <div className="text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              This Privacy Policy explains how Aim Trainer - SLOX (&quot;we&quot;,
              &quot;our&quot;, or &quot;the App&quot;) handles information when you use our
              mobile application. Aim Trainer - SLOX is a casual aim and reaction training
              game: players tap moving targets within a 30-second round, and a score is
              computed from accuracy and average reaction time.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>No Account Required:</strong> Aim Trainer - SLOX does not require sign-up,
            ...
            <p className="mb-2">
              ...
              a freely-chosen public nickname, the score (hits, accuracy, average reaction
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Your best score, accuracy, and recent records</li>
          ...
          <section>
            ...
            <p className="mb-2">
              Aim Trainer - SLOX displays advertisements through <strong>Google AdMob</strong>,
          ...
          <section>
            ...
            <p>
              Aim Trainer - SLOX is rated 4+ and is safe for users of all ages, but it is not
              specifically targeted at children. We do not knowingly collect personal information
              from children. The game does not depict realistic firearms or violence; targets
              are abstract on-screen shapes. Because advertisements are delivered by Google
              AdMob, the App is not suitable for designated &quot;Kids Category&quot; distribution.
            </p>
          </section>
