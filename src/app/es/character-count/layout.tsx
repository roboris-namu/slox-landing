...
export const metadata: Metadata = {
  ...
  description: "Contador de caracteres gratis. Verifica caracteres y palabras.",
  keywords: ["contador caracteres", "character counter"],
  alternates: {
    canonical: "https://www.slox.co.kr/es/character-count",
    languages: {
  ...
  openGraph: {
    type: "website",
    locale: "es_ES",
    url: "https://www.slox.co.kr/es/character-count",
    siteName: "SLOX",
    title: "Contador de Caracteres | SLOX",
  },
